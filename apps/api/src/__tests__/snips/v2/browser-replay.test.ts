...
describe("Interact session replay", () => {
  ...
  itIf(canRunReplayHappyPath)(
    "omits disabled viewer/recording links and reports no replay",
    async () => {
      ...
      try {
        ...
        expect(created.body.liveViewUrl).toBeUndefined();
        expect(created.body.interactiveLiveViewUrl).toBeUndefined();
